...
/// </summary>
public sealed class MqttSnRegAckPacket : IMqttSnPacket
{
    /// <summary>
    /// 报文固定长度。
    /// </summary>
    ...
    /// <inheritdoc/>
    public MqttSnPacketType PacketType => MqttSnPacketType.RegAck;
    ...
    public int WriteTo(Span<byte> buffer)
    {
        ...
        buffer[1] = (byte)MqttSnPacketType.RegAck;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MqttSnRegAckPacket Parse(ReadOnlySpan<byte> buffer)
    {
        return new MqttSnRegAckPacket
        {
