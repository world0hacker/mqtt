...
/// </summary>
public sealed class MqttSnConnAckPacket : IMqttSnPacket
{
    /// <summary>
    /// 报文固定长度。
    /// </summary>
    ...
    /// <inheritdoc/>
    public MqttSnPacketType PacketType => MqttSnPacketType.ConnAck;
    ...
    public int WriteTo(Span<byte> buffer)
    {
        ...
        buffer[1] = (byte)MqttSnPacketType.ConnAck;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MqttSnConnAckPacket Parse(ReadOnlySpan<byte> buffer)
    {
        return new MqttSnConnAckPacket
        {
