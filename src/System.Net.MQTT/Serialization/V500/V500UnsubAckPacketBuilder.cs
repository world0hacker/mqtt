...
/// <summary>
/// MQTT 5.0 UNSUBACK 报文构建器。
/// </summary>
public sealed class V500UnsubAckPacketBuilder : IUnsubAckPacketBuilder
{
    private readonly V500PropertyBuilder _propertyBuilder;

    public V500UnsubAckPacketBuilder(V500PropertyBuilder propertyBuilder)
    {
    ...
    {
        var packet = new MqttUnsubAckPacket { PacketId = packetId };
    ...
    public int CalculateSize(MqttUnsubAckPacket packet)
    {
        var size = 2; // PacketId
